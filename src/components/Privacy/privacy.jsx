  ...
  return (
    <div className="container-privacy">
      ...
      <div className="privacy">
        <h1>Buyuk yo'l Privacy Policy</h1>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Buyuk yo'l, the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Buyuk yol, Uzbekistan.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Buyuk yo'l, accessible from{" "}
              <a
                href="https://client.buyukyol.uz/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://client.buyukyol.uz/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: buyukyollogistic@gmail.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://buyukyol.uz/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://buyukyol.uz/contact
              </a>
            </p>
          </li>
          <li>
            <p>By phone number: +998955777971</p>
          </li>
        </ul>
      </div>
